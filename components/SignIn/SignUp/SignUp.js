...
const SignUp = () => {
  ...
  `;
  const [signupMutation, { error, loading, data }] = useMutation(SIGNUP_MUTATION);
          ...
          <div>
            ...
            <Form className='flex flex-col justify-center items-center'>
              <div className='flex justify-center items-center'>
                <label className=' block text-gray-500 font-bold   pr-4'> Name </label>
                <FieldComponent name='name' placeholder='John Cena' autoFocusBool={true} />
              </div>
              <div className='flex'>
                <label className=' block text-gray-500 font-bold   pr-4'> Email </label>
                <FieldComponent type='email' name='email' placeholder='john@cena.com' />
              </div>
              <div className='flex'>
                <label className=' block text-gray-500 font-bold   pr-4'> Password </label>
                <FieldComponent type='password' name='password' placeholder='*******' />
              </div>
              ...
              {errors.email && touched.email ? (
                <div className=' left-50 my-1 text-red-600'>* {errors.email}</div>
              ) : (
                <div className='w-40'></div>
              )}
